...
This guide heavily references from <a href="https://github.com/evangelistalab/forte/issues/277" target="_blank">Francesco’s psi4/ambit/forte setup (Mac BigSur 11.6.1, Dec. 2021)</a>
...
<aside>
It is also possible to specify channel mirrors, e.g., <a href="https://mirror.tuna.tsinghua.edu.cn/help/anaconda" target="_blank">Anaconda 软件仓库</a>
</aside>
...
<aside>
If you see the error message `icpx: error: Use of ‘-qopenmp’ recommended over ‘-fopenmp’ [-Werror,-Wrecommended-option]`,
you may replace `–fopenmp` to `-qopenmp` in `CMakeLists.txt`.
</aside>

## 8. Install Psi4 from Source (Developer)
...
If Eigen error `fatal error: ‘eigen3/Eigen/Core’ file not found` occurs,
...
🎉 Hooray! You compiled Forte successfully!
