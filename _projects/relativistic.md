...
#description:
#img: assets/img/publication_preview/2025SOC.png
importance: 2
category: [method development]
related_publications: true
---

Relativistic effects become essential for molecules containing heavy elements, where high nuclear charges lead to significant scalar relativistic corrections and spin–orbit coupling (SOC).
